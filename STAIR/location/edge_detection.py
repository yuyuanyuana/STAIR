...
def detect_edge_of_domains(adatas, domain_key, domains_use, spatial_key='spatial', alpha=50):
    ...
    for i in range(len(domains_use)): 
        ...
        for domain_use_tmp in domain_use:
            ...
            edge_use_tmp1 = {(index_tmp_dict1[i], index_tmp_dict1[j]) for i,j in edge_tmp1}   # combine slice edge and domain edge
            ...
            edge_use_tmp2 = {(index_tmp_dict2[i], index_tmp_dict2[j]) for i,j in edge_tmp2}
